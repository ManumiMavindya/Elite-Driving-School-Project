...
public class StudentCourseDetailsDAOImpl implements StudentCourseDetailsDAO {
    ...
    public List<StudentCourseDetails> getAll() throws Exception {
        ...
        try {
            Query<StudentCourseDetails> query = session.createQuery("from StudentCourseDetails where course_id");
            List<StudentCourseDetails> studentCourseDetails = query.list();
